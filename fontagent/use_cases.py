...
SURFACE_KEYWORDS = {
    ...
    "scene_overlay": ["scene", "overlay", "broadcast", "clean", "readable"],
...
USE_CASE_PRESETS = {
    ...
    "knowledge-video-white-ko": {
        "medium": "video",
        "surface": "scene_overlay",
        "role": "title",
        "tones": ["knowledge", "documentary", "editorial", "clean"],
        "task_suffix": "knowledge explainer documentary video scene overlay clean editorial korean",
        "target": "both",
        "role_queries": {
            "title": "korean title clean editorial readable documentary knowledge explainer",
            "subtitle": "korean subtitle readable neutral sans clean knowledge video",
            "body": "korean body readable editorial neutral knowledge video",
        },
    },
    "knowledge-video-quirky-ko": {
        "medium": "video",
        "surface": "scene_overlay",
        "role": "title",
        "tones": ["knowledge", "playful", "quirky", "clean"],
        "task_suffix": "knowledge explainer quirky playful video scene overlay clean korean",
        "target": "both",
        "role_queries": {
            "title": "korean title playful display bold quirky knowledge explainer",
            "subtitle": "korean subtitle readable neutral sans playful clean knowledge video",
            "body": "korean body readable neutral sans clean playful knowledge video",
        },
    },
    "video-thumbnail": {
        "medium": "video",
